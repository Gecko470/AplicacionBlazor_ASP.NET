...
namespace MiPrimeraAplicacionBlazor.Shared
{
    public class PersonasCLS
    {
        ...
        public string fecha { get; set; }/*Es conveniente poner la fecha en formato string SOLO para el listado*/

        [Required(ErrorMessage = "Campo Tipo Usuario es obligatorio")]
        ...
        public string contrasenia { get; set; } = "12345678";
    }
